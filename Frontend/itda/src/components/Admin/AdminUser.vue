...
//관리자는 0
    ...
    export default {
        ...
        methods: {
            ...
            {
                axios
                    .get('https://192.168.31.54:8197/itda/api/getAllUsers/')
                    .then(res => {
                        console.log(res)
            ...
            deleteItem(item)
            {
                ...
                {
                    axios
                    .delete('https://192.168.31.54:8197/itda/api/deleteUser/'+ item.uid)
                    .then(res => {
            ...
            ChangeItem(item)
            {
                ...
                {   
                    ...
                    axios
                    .put('https://192.168.31.54:8197/itda/api/updatePermission/', { uid, auth })
                    .then(res => {
                        alert(res.data.msg)
                        if(res.data.state == 'success'){
                            this.getAllUsers();
