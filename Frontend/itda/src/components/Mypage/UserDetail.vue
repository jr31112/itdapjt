                ...
                <v-list one-line="two-line">
                    ...
                    <v-list-item>
                        <v-list-item-content>
                            ...
                            <v-list-item-subtitle>{{userInfo.user.major}}</v-list-item-subtitle>
                        </v-list-item-content>
                    </v-list-item>
                    <v-divider></v-divider>
                    <v-list-item>
                    ...
                    <v-list-item>
                        <v-list-item-content>
                            <v-list-item-title>취업 정보</v-list-item-title>
                            <v-list-item-subtitle>{{userInfo.user.cid}}</v-list-item-subtitle>
                        </v-list-item-content>
                    </v-list-item>
                </v-list>
            </v-card>
