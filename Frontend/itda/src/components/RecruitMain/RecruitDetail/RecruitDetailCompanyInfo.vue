          ...
          <v-list-item>
            <v-list-item-content>
              <v-list-item-title two-line>
                <p class="mb-0" v-if="company.busiSize">{{company.busiSize}}</p>
                <p class="mb-0" v-else>-</p>
              </v-list-item-title>
              
              <v-list-item-subtitle>기업형태</v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
        </v-card>
      </v-col>
        ...
        <v-card class="mx-0">
          <v-list-item>
            <v-list-item-content>
              ...
              <v-list-item-subtitle>사원수</v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
        </v-card>
      </v-col>
        ...
        <v-card class="mx-0">
          <v-list-item>
            <v-list-item-content>
              ...
              <v-list-item-subtitle>매출</v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
        </v-card>
      </v-col>
