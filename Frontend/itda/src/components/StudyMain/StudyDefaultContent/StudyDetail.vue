...
export default {
    ...
    methods:{
        ...
        enter() {
            axios.post('http://192.168.31.54:8197/itda/api/createStudyGroup',{"stid":this.study.stid},{'headers' : {"jwt-auth-token": localStorage.getItem("access_token")}})
            .then(
                ()=>{
        ...
        exit() {
            axios.delete('http://192.168.31.54:8197/itda/api/deleteStudyGroup/' + this.study.stid ,{'headers' : {"jwt-auth-token": localStorage.getItem("access_token")}})
            .then(
                ()=>{
        ...
        del() {
            axios.delete('http://192.168.31.54:8197/itda/api/deleteStudy/' + this.study.stid ,{'headers' : {"jwt-auth-token": localStorage.getItem("access_token")}})
            .then(
                ()=>{
        ...
        getStudyDetail(id){
            axios.get('http://192.168.31.54:8197/itda/api/getStudyGroup/'+id)
                .then(response => {
