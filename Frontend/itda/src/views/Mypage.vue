                            ...
                            <v-card width="500px">
                                ...
                                <v-card-text>
                                    <v-form ref="form" v-model="valid">
                                        <v-text-field v-model="formData.pw" @keydown.enter.prevent="validate" type="password" label="비밀번호" :rules="[v => !!v || '비밀번호를 입력해주세요']"></v-text-field>
                                    </v-form>
                                </v-card-text>
                                <v-card-actions>
                                    <v-spacer></v-spacer>
                                   
                                    <v-btn type="submit" text color="success" class="mr-4" @click="validate">submit</v-btn>
