...
export default {
    ...
    methods:{
        getData(){
            ...
            if (type == 1){
                axios.get('https://192.168.31.54:8197/itda/api/getWantedAll')
                .then((response)=>{
                ...
                axios.get('https://192.168.31.54:8197/itda/api/getAllCompanys')
                    .then((response)=>{
                            this.searchresults = response.data
                        })
                    .catch()
                ...
                axios.get('https://192.168.31.54:8197/itda/api/getAllStacks')
                    .then((response)=>{
                            this.searchresults = response.data
                        })
                    .catch()
